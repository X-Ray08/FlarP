...
@style([
    'color: green',
'background-color: grey' => $country==='ge'
])
>
...
{{-- <br>
@include('Shared.Buttons',['color'=> 'green','text'=>'Submit'])
@php
    $cars=[1,2,3,4,5];
@endphp
@foreach ($cars as $car)
    @include('shared.buttons',['color'=>'grey','text'=>$car])
@endforeach
@each('cars.view', $cars, 'car', 'view.empty') --}}
{{-- @includeif('Shared.Buttons',['color'=> 'green','text'=>'Submit'])
@includeWhen(true,'Shared.Buttons',['color'=> 'green','text'=>'Submit'] )
@includeFirst(['Buttons','Shared.Buttons'],['color'=>'blue','text'=>'blue']) --}}


{{-- use function, both are same --}}
{{-- @php
...
{{-- @include('alert',['message'=>'your account was created',
'color'=>'red']) 
 @include('alert',['message'=>'your account is not created',
'color'=>'blue'])  --}}
